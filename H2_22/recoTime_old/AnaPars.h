...
struct anaPar {
    ...
    static constexpr double wfEx = 0; 
    static constexpr double wfEy = 0;
    ...
    // static constexpr int dsScanVal[dsScanPts] = {1, 2, 3, 4, 5, 6, 7, 8};
